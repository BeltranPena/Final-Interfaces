...
if(window.scrollY > 40){
    ...
    vertNav.classList.add("stickyNav");
    }
    else{
        header.classList.remove("stickyHeader");
        vertNav.classList.remove("stickyNav");
    }
}
);

let images = document.querySelectorAll(".cardPrev");
let btnImages = document.querySelectorAll(".btnPreview");

btnImages.forEach((btnImages) => {
...
let risers = document.querySelectorAll(".closeUp");

window.addEventListener("scroll", rise);
function rise(){
    risers.forEach((riser) => {
        let top = riser.getBoundingClientRect().top;
        if (top < trigger) {
            riser.classList.add("rise");
        }
    });
}
...
let personajesIzq = document.querySelectorAll(".personajeIzq");
let personajesDer = document.querySelectorAll(".personajeDer");

//--------------- Historia ----------------------------------

let texto1 = document.querySelector("#historiaUno");
let texto2 = document.querySelector("#historiaDos");
let texto3 = document.querySelector("#historiaTres");
let texto4 = document.querySelector("#historiaCuatro");

let imagen1 = document.querySelector("#imagenUno");
let imagen2 = document.querySelector("#imagenDos");
let imagen3 = document.querySelector("#imagenTres");
let imagen4 = document.querySelector("#imagenCuatro");
...
function scrollAppear(){
    ...
    personajesIzq.forEach((personaje) => {
        let bottom = personaje.getBoundingClientRect().bottom;
        let scroll = window.innerHeight;
        if (bottom < scroll) {
            personaje.classList.add("slideRight");
        }
    });

    personajesDer.forEach((personaje) => {
        let bottom = personaje.getBoundingClientRect().bottom;
        let scroll = window.innerHeight;
        if (bottom < scroll) {
            personaje.classList.add("slideLeft");
        }
    });
    ...
    let topPosition = texto1.getBoundingClientRect().top;
    let topPosition1 = texto2.getBoundingClientRect().top;
    let topPosition2 = texto3.getBoundingClientRect().top;
    let topPosition3 = texto4.getBoundingClientRect().top;
    let botPosition3 = texto4.getBoundingClientRect().bottom;

    if (topPosition < position/2) {
        imagen1.classList.add("showImage");
        texto1.classList.remove("fade-in");
        if(imagen2.classList.contains("showImage")){
            imagen2.classList.remove("showImage");
            texto2.classList.add("fade-in");
        }
    }
    else{
        texto1.classList.remove("appear");
        imagen1.classList.remove("showImage");
    }

    if (topPosition1 < position) {
        imagen1.classList.remove("showImage");
        texto1.classList.add("fade-in");
        imagen2.classList.add("showImage");
        texto2.classList.remove("fade-in");
        if(imagen3.classList.contains("showImage")){
            imagen3.classList.remove("showImage");
            texto3.classList.add("fade-in");
        }
    }
    ...
    if (topPosition2 < position) {
        imagen2.classList.remove("showImage");
        texto2.classList.add("fade-in");
        imagen3.classList.add("showImage");
        texto3.classList.remove("fade-in");
        if(imagen4.classList.contains("showImage")){
            imagen4.classList.remove("showImage");
            texto4.classList.add("fade-in");
        }
    }

    if (topPosition3 < position) {
        imagen3.classList.remove("showImage");
        texto3.classList.add("fade-in");
        imagen4.classList.add("showImage");
        texto4.classList.remove("fade-in");
    }

    if (botPosition3 < (position)*1.3) {
        imagen4.classList.remove("showImage");
        texto4.classList.add("fade-in");
    }
